            ...
            <div className="bg-[url('/public/images/bg.jpg')] bg-cover bg-center relative after:absolute after:inset-0 after:bg-primary/90 text-white">
                <div className="container-lg py-[5rem] h-full relative z-10 grid lg:grid-cols-4 md:grid-cols-2 grid-cols-1 gap-5">
                    <div className="space-y-4">
                        <h4 className='md:text-2xl text-xl uppercase tracking-widest'>Get In Touch</h4>
                    ...
                    <div className="space-y-4">
                        <h4 className='md:text-2xl text-xl uppercase tracking-widest'>Follow Us</h4>
                    ...
                    <div className="space-y-4">
                        <h4 className='md:text-2xl text-xl uppercase tracking-widest'>Open Hours</h4>
                        <ul className='space-y-3'>
                            <li>
                    ...
                    <div className="space-y-4">
                        <h4 className='md:text-2xl text-xl uppercase tracking-widest'>Newsletter</h4>
                        <p>Amet elitr vero magna sed ipsum sit kasd sea elitr lorem rebum</p>
