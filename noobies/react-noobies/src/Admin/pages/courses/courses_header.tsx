...
export default function MainCoursesHeader() {
    return (
        <div className="flex flex-col md:flex-row items-center justify-between gap-3 mb-10">
            ...
            <div className="flex flex-col sm:flex-row w-full items-center justify-end gap-3">
                <a href='/admin/main/main-categories/add' className='border border-reply-dark-color text-reply-color px-5 py-3 rounded-md text-sm font-normal focus:outline-none foucs:ring-0 transition-colors hover:bg-reply-color hover:text-white'>Add Course</a>
            </div>
        </div>
    )
}
